...
import com.myapp.job_application_tracker.exception.GeminiResponseError;
...
public class AIAutofillService {
    ...
    private AutofillResponse callGeminiApi(String webContent){
        ...
        try{
            ...
            throw new GeminiResponseError("Fail to get response from gemini-2.5-flash.");
        }
        if(response == null){
            throw new GeminiResponseError("Fail to get response from gemini-2.5-flash.");
        }
        ...
        try{
            ...
            System.out.println(extractedJsonString);
